...
// ===================================================================
// 🧠 1. THEME PROVIDER — Handles theme switching & persistence
// ===================================================================
class ThemeProvider with ChangeNotifier {
...
// ===================================================================
// 🎨 2. APP COLOR PALETTE — Base colors for light & dark themes
// ===================================================================
const _primary = Color.fromARGB(255, 137, 0, 155); // Neon Violet
const _secondary = Color.fromARGB(255, 197, 5, 245); // Magenta Accent
const _darkBg = Color(0xFF12121A);
const _lightBg = Color(0xFFF0F2F5);

// ===================================================================
// 🌞 3. LIGHT THEME — Bright, clean, and vibrant
// ===================================================================
final ThemeData lightTheme = ThemeData(
  brightness: Brightness.light,
  useMaterial3: true,
...
// ===================================================================
// 🌙 4. DARK THEME — Smooth, modern, and eye-friendly
// ===================================================================
final ThemeData darkTheme = ThemeData(
  brightness: Brightness.dark,
  useMaterial3: true,
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      backgroundColor: Color.fromARGB(255, 128, 128, 129),
